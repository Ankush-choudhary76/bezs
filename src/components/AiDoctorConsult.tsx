...
export const AiDoctorConsult = ({ prompt }: { prompt: string }) => {
  ...
  return (
    <div className="p-8 border rounded-2xl bg-secondary/10 max-w-[800px] mx-auto">
      ...
      <div className="flex items-center flex-col mt-10">
        <Image
          src={
            "https://images.unsplash.com/photo-1612276529731-4b21494e6d71?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          }
          alt={"General Specialization"}
          width={120}
          height={120}
          className="h-[100px] w-[100px] object-cover rounded-full"
        />
        <h2 className="mt-2 text-lg capitalize">Usman Yousaf</h2>
        <p className="text-sm">(General Specialization)</p>
